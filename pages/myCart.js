              ...
              <div className="bg-subtheme h-screen w-full ">
                ...
                <div className="">
                  ...
                  {filteredProducts.length ? (
                    <div className="fixed lg:absolute bottom-0 left-0 w-full py-4 shadow">
                      <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
                        <div className="flex justify-center">
                          ...
                          <Link
                            ...
                            className="bg-button text-sm text-white font-semibold px-4 py-2 mr-4 rounded"
                          >
                            Checkout !
                          </Link>
                        </div>
