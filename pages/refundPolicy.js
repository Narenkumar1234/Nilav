...
export default function RefundPolicy(){
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 h-min-screen lg:h-screen text-gray-800">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="mb-8">
            We are available during our business hours (Mon - Fri 9AM - 9PM) to
            assist you promptly.
          </p>

          <p className="mb-8">
            We value our customers and strive to provide a transparent and fair
            cancellation and refund policy. If you have any further questions or
