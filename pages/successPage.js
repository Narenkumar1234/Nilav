...
export default function SuccessPage(){
    return (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#539032" class="mx-auto w-6/12 animate-bounce">
      ...
      <Link href="/" className='bg-theme  py-2 px-5 text-white  rounded-lg'>Contine Shopping
